...
QBCore.Functions.CreateUseableItem("uwububbleteablueberry", function(source, item)
    ...
    if Player.Functions.RemoveItem(item.name, 1, item.slot) then
        TriggerClientEvent("qb-uwujob:client:uwububbleteablueberry", source, item.name) 
    end
end)
...
QBCore.Functions.CreateUseableItem("uwupancake", function(source, item)
    local Player = QBCore.Functions.GetPlayer(source)
    if Player.Functions.RemoveItem(item.name, 1, item.slot) then
        TriggerClientEvent("qb-uwujob:client:uwusandy", source, item.name)  
    end
end)
...
QBCore.Functions.CreateUseableItem("uwubudhabowl", function(source, item)
    local Player = QBCore.Functions.GetPlayer(source)
    if Player.Functions.RemoveItem(item.name, 1, item.slot) then
        TriggerClientEvent("qb-uwujob:client:budhabowl", source, item.name) 
    end
end)
...
QBCore.Functions.CreateUseableItem("uwumisosoup", function(source, item)
    local Player = QBCore.Functions.GetPlayer(source)
    if Player.Functions.RemoveItem(item.name, 1, item.slot) then
        TriggerClientEvent("qb-uwujob:client:misosoup", source, item.name) 
    end
end)
